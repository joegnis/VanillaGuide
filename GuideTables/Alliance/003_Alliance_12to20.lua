...
-----------18-20 Redredge Mountains
	...
	[1820] = {
		...
		items = {
			...
			[19] = { str = "Do  Assessing the Threat  at 29,83 and 41,73.", x = 41, y = 73, zone = "Redridge Mountains"},
			[20] = { str = "Kill condors for  Redridge Goulash  around 57,73", x = 57, y = 73, zone = "Redridge Mountains" },
			[21] = { str = "Turn in  Assessing the Threat  near the FP" },
			[22] = { str = "Accept  Murloc Poachers  in front of the shed." },
